...
public class StreetContainer {
    ...
    public StreetContainer()
    {
        length = 1;
        height = 1;
        leftSide = new LDLinkedList<LDLinkedList<Boolean>>();
        rightSide = new LDLinkedList<LDLinkedList<Boolean>>();
    }
    ...
    public StreetContainer(int toLength)
    {
        ...
        {
            leftSide.add(new LDLinkedList<Boolean>());
            leftSide.get(i).add(false);
        }
        for(int i = 0; i < length; ++i)
        {
            rightSide.add(new LDLinkedList<Boolean>());
    ...
    {
        LDLinkedList<LDLinkedList<Boolean>> silhouetteContainer = new LDLinkedList<LDLinkedList<Boolean>>();
        
        for(int j = 0; j < length; ++j)
        {
            silhouetteContainer.add(new LDLinkedList<Boolean>());
    ...
    private LDLinkedList<LDLinkedList<Boolean>> leftSide;
    private LDLinkedList<LDLinkedList<Boolean>> rightSide;
    private int length;
    private int height;
}
