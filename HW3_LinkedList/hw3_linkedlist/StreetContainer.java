...
public class StreetContainer {
    ...
    public StreetContainer()
    {
        length = 1;
        height = 1;
        leftSide = new LinkedList<LinkedList<Boolean>>();
        rightSide = new LinkedList<LinkedList<Boolean>>();
    }
    ...
    public StreetContainer(int toLength)
    {
        ...
        {
            leftSide.add(new LinkedList<Boolean>());
            leftSide.get(i).add(false);
        }
        for(int i = 0; i < length; ++i)
        {
            rightSide.add(new LinkedList<Boolean>());
    ...
    {
        LinkedList<LinkedList<Boolean>> silhouetteContainer = new LinkedList<LinkedList<Boolean>>();
        
        for(int j = 0; j < length; ++j)
        {
            silhouetteContainer.add(new LinkedList<Boolean>());
    ...
    private LinkedList<LinkedList<Boolean>> leftSide;
    private LinkedList<LinkedList<Boolean>> rightSide;
    private int length;
    private int height;
}
